...
class Brand
{
    ...
    public function getAsins($productGroup, $binding, $brand, int $page)
    {
        $cacheKey = md5(__METHOD__ . $productGroup . $binding . $brand . $page);
        ...
        $sql = "
            SELECT `product`.`asin`
             ...
             LIMIT $offset, 100
                 ;
        ";
        $results = $this->adapter->query($sql, [$productGroup, $binding, $brand]);
    ...
    /**
     * Count the number of products for a brand.
     *
