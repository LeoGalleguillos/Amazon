    ...
    public function getServiceConfig()
    {
        return [
            'factories' => [
                ...
                AmazonService\Product\Products\ProductGroup::class => function ($sm) {
                    return new AmazonService\Product\Products\ProductGroup(
                        $sm->get(AmazonFactory\Product::class),
                ...
                AmazonService\Product\Products\ProductGroupBrand::class => function ($sm) {
                    return new AmazonService\Product\Products\ProductGroupBrand(
                        $sm->get(AmazonFactory\Product::class),
                        $sm->get(AmazonTable\Product\ProductGroupBrand::class)
                    );
                },
                ...
                AmazonTable\Product\ProductGroup::class => function ($sm) {
                    return new AmazonTable\Product\ProductGroup(
                        $sm->get('amazon'),
                        $sm->get(AmazonTable\Product::class)
                    );
                },
                ...
                AmazonTable\Product\ProductGroupBrand::class => function ($sm) {
                    return new AmazonTable\Product\ProductGroupBrand(
                        $sm->get('amazon'),
                        $sm->get(AmazonTable\Product::class)
                    );
                },
